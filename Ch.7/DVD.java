/*
   ...
   Date:       April 15, 2014
   Filename:   DVD.java
   Purpose:    This program creates a Swing interface for sorting a DVD collection
*/
   ...
   public Container createContentPane()
   {
      ...
      protected void setTabsAndStyles(JTextPane textPane)
      {
         ...
         public void actionPerformed(ActionEvent e)
         {
            ...
            //user click Title on the Search submenu
            if (arg == "title")
               search(arg, title);
            ...
            try
            {
               ...
               for (int i = 0; i<title.length; i++)
               {
                  if (search.compareTo(searchArray[i])==0)
                  {
                     ...
                     doc.insertString(doc.getLength(), studio[i] +"\t", textPane.getStyle("itlaic"));
