			...
			implements ActionListener, ItemListener, WindowListener, STAction
{
	...
	JLabel lblUserID = new JLabel( "User ID:", SwingConstants.LEFT );
	JLabel lblFName = new JLabel( "First Name:", SwingConstants.LEFT );
 	JLabel lblLName = new JLabel( "Last Name:", SwingConstants.LEFT );
	JLabel lblPswd = new JLabel( "Password:", SwingConstants.LEFT );
	JLabel lblPswd2a = new JLabel( "Re-enter", SwingConstants.LEFT );
	JLabel lblPswd2b = new JLabel( "Password:", SwingConstants.LEFT );
	JLabel lblAutoExp = new JLabel( "Auto Expires:", SwingConstants.LEFT );
	JLabel lblUses = new JLabel( "Uses Left: ", SwingConstants.LEFT );
    		...
    		throws ClassNotFoundException,SQLException
    {
        ...
        p5.add(workPanel, BorderLayout.CENTER);
        p5.add(buttonPanel, BorderLayout.SOUTH);
	...
	private JPanel createListPanel()
	{
		...
		ArrayList rs;
		StringBuffer[] a2 = new StringBuffer[4];
