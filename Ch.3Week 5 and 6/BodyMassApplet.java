...
public class BodyMassApplet extends Applet implements ActionListener
{
   ...
   Label companyLabel = new Label("THE SUN FITNESS CENTER BODY MASS INDEX CALCUATOR");
   ...
   Label outputLabel = new Label("Click the Calculate buttonto see your body mass index.");
